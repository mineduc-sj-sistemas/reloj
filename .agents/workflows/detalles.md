...
11	Licencias, Vacaciones y Francos Compensatorios	¿Cómo se administran las vacaciones por antigüedad y los francos?
        ...
        DUDAS PENDIENTES A CONSULTAR CON PERSONAL:
        - ¿Cuál es la escala exacta de días de vacaciones según antigüedad acá en la provincia?
        - Si a alguien le sobran días de vacaciones este año, ¿hasta cuántos años puede acumularlos antes de que prescriban (1 o 2 años)?
        - ¿El sistema debería calcular los días automáticamente según un campo de antigüedad (fecha de ingreso), o lo calculan ellos a mano? (Recomendación técnica: que el sistema calcule y sugiera automáticamente los días según la fecha de ingreso, pero permitiendo que el operador pueda editarlo manualmente por si hay resoluciones especiales o reconocimiento de años de otros organismos).
